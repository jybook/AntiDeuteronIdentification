...
if ! [ -f InputFile.root ] ; then
   error=1
   echo "Output file InputFile.root not found. Job FAILED !" >> stdout
   echo "Output file InputFile.root not found. Job FAILED !" >> stderr
fi
if ! [ -f Input_QA.root ] ; then
   error=1
   echo "Output file Input_QA.root not found. Job FAILED !" >> stdout
   echo "Output file Input_QA.root not found. Job FAILED !" >> stderr
fi
